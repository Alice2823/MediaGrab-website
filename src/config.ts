...
export const DOWNLOAD_URL =
  "https://github.com/Alice2823/MediaGrab-software/releases/download/v1.0.11/MediaGrab.Setup.1.0.11.exe";
...
export const APP_CONFIG = {
  ...
  siteUrl: (typeof process !== 'undefined' && process.env?.VITE_SITE_URL) || (typeof import.meta !== 'undefined' && import.meta.env?.VITE_SITE_URL) || "https://mediagrabs.com",
